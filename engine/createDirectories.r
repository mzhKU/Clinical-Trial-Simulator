createDirectories <- function(
  dirNames = c("ReplicateData", "MicroEvaluation",
                                "MacroEvaluation"),          # A vector containing
                                                             # the full names of
                                                             # the directories to
                                                             # be created.
  # dirNames = c("ReplicateData", "Micro", "EvalMacro"),   # A vector containing
                                                             # the full names of
                                                             # the directories to
                                                             # be created.
...
)
{
  ...
  if (length(dirNames) > 1) {
	 ...
	 return(checkTrue)
	  ...
	  if (substring(dirNames, 1, 1) == "E") method <- "CSV"
